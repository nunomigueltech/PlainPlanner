...
public class DateValidator implements ConstraintValidator<ValidDate, NewItemDTO>{
	...
	@Override
	public boolean isValid(NewItemDTO dto, ConstraintValidatorContext context) {
