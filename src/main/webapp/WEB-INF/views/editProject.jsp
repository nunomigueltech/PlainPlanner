...
<head>
    ...
    <title>PlainPlanner - Edit Project</title>
</head>
<body>
	<div id="wrapper">
	    ...
	    <section id="statistics-section" class="mb-5 mt-3">
	    	<div class="container">
	    		<div class="card">
	    			...
	    			<div class="card-body">
							<form:form action="/updateProject" method="post" modelAttribute="item">
								<form:hidden path="id" value="${project.id}" />
								<div class="row my-2">
			    					<div class="input-group justify-content-center">
			    						<form:label class="col-sm-2 col-form-label" path="title">Title</form:label>
			    						<div class="col-sm-4">
			    							<form:input type="text" class="login-control form-control" value="${project.title}" path="title"></form:input>
			    						</div>
			    					</div>
			    				</div>
			    				<div class="row my-2">
			    					<div class="input-group justify-content-center">
			    						...
			    						<div class="col col-sm-4">
			    							<c:choose>
			    								...
			    								<c:otherwise>
			    									<a href="/addProjectDeadline/${project.id}" class="btn btn-outline-primary btn-sm">Add deadline</a>
			    								</c:otherwise>
			    							</c:choose>
			    						</div>
			    					</div>
